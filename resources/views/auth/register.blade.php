                ...
                <div class="step-progress">
                    ...
                    <div class="step-indicators">
                        <div class="step-indicator active" data-step="1">
                            <div class="step-number">1</div><span class="step-label">Profil</span>
                        </div>
                        <div class="step-indicator" data-step="2">
                            <div class="step-number">2</div><span class="step-label">Identité</span>
                        </div>
                        <div class="step-indicator" data-step="3">
                            <div class="step-number">3</div><span class="step-label" id="step3Label">Projet</span>
                        </div>
                        <div class="step-indicator" data-step="4">
                            <div class="step-number">4</div><span class="step-label">Validation</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-step active" data-step="1">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="radio" name="account_type" value="particulier" id="type_particulier"
                                    class="d-none" {{ old('account_type')=='particulier' ? 'checked' : '' }}>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="radio" name="account_type" value="entreprise" id="type_entreprise"
                                    class="d-none" {{ old('account_type')=='entreprise' ? 'checked' : '' }}>
                            </div>
                        </div>

                        @error('account_type')
                        <div class="alert alert-danger mt-3"><i class="fas fa-exclamation-circle me-2"></i>{{ $message
                            }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-step" data-step="2">
                        ...
                        <div id="formParticulier" class="{{ old('account_type') == 'entreprise' ? 'd-none' : '' }}">
                            <div class="card border-0 bg-light mb-4">
                                <div class="card-body">
                                    <h5 class="text-primary mb-3"><i class="fas fa-user me-2"></i>Identité personnelle
                                    </h5>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Nom complet <span
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Téléphone <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Ville <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="city" id="p_city"
                                                class="form-control form-control-lg @error('city') is-invalid @enderror"
                                                value="{{ old('city') }}" required onblur="saveUserData()">
                                            @error('city')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Adresse <span
                                                    class="text-danger">*</span></label>
                            ...
                            <div class="card border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Mot de passe <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-outline-secondary" type="button"
                                                    onclick="togglePass('pwd1')"><i class="fas fa-eye"></i></button>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Confirmation <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="password" name="password_confirmation" id="pwd2"
                                                    class="form-control form-control-lg" required>
                                                <button class="btn btn-outline-secondary" type="button"
                                                    onclick="togglePass('pwd2')"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="formEntreprise" class="{{ old('account_type') != 'entreprise' ? 'd-none' : '' }}">
                            <div class="card border-0 bg-light mb-4">
                                <div class="card-body">
                                    <h5 class="text-primary mb-3"><i class="fas fa-user-tie me-2"></i>Responsable du
                                        compte</h5>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Nom complet <span
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Fonction <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="position" id="e_position"
                                                class="form-control form-control-lg @error('position') is-invalid @enderror"
                                                value="{{ old('position') }}" required placeholder="DG, Manager..."
                                                onblur="saveUserData()">
                                            @error('position')<div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Email professionnel <span
                                                    class="text-danger">*</span></label>
                            ...
                            <div class="card border-0 bg-light mb-4 border-start border-4 border-primary">
                                <div class="card-body">
                                    <h5 class="text-primary mb-3"><i class="fas fa-building me-2"></i>Informations de
                                        l'entreprise</h5>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Nom de l'entreprise <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="company_name" id="e_company_name"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Forme juridique <span
                                                    class="text-danger">*</span></label>
                                            <select name="company_type" id="e_company_type"
                                                class="form-select form-select-lg @error('company_type') is-invalid @enderror"
                                                required onchange="saveUserData()">
                                                <option value="">Sélectionner</option>
                                                <option value="sarl" {{ old('company_type')=='sarl' ? 'selected' : ''
                                                    }}>SARL</option>
                                                <option value="sa" {{ old('company_type')=='sa' ? 'selected' : '' }}>SA
                                                </option>
                                                <option value="ei" {{ old('company_type')=='ei' ? 'selected' : '' }}>
                                                    Entreprise Individuelle</option>
                                                <option value="cooperative" {{ old('company_type')=='cooperative'
                                                    ? 'selected' : '' }}>Coopérative</option>
                                                <option value="ong" {{ old('company_type')=='ong' ? 'selected' : '' }}>
                                                    ONG / Association</option>
                                                <option value="autre" {{ old('company_type')=='autre' ? 'selected' : ''
                                                    }}>Autre</option>
                                            </select>
                                            @error('company_type')<div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Secteur d'activité <span
                                                    class="text-danger">*</span></label>
                                            <select name="sector" id="e_sector"
                                                class="form-select form-select-lg @error('sector') is-invalid @enderror"
                                                required onchange="saveUserData()">
                                                <option value="">Sélectionner</option>
                                                <option value="agriculture" {{ old('sector')=='agriculture' ? 'selected'
                                                    : '' }}>Agriculture</option>
                                                <option value="commerce" {{ old('sector')=='commerce' ? 'selected' : ''
                                                    }}>Commerce</option>
                                                <option value="services" {{ old('sector')=='services' ? 'selected' : ''
                                                    }}>Services</option>
                                                <option value="technologie" {{ old('sector')=='technologie' ? 'selected'
                                                    : '' }}>Technologie</option>
                                                <option value="industrie" {{ old('sector')=='industrie' ? 'selected'
                                                    : '' }}>Industrie</option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Pays <span
                                                    class="text-danger">*</span></label>
                                            <select name="country" id="e_country"
                                                class="form-select form-select-lg @error('country') is-invalid @enderror"
                                                required onchange="saveUserData()">
                                                <option value="">Sélectionner</option>
                                                <option value="senegal" {{ old('country')=='senegal' ? 'selected' : ''
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="password" name="password" id="pwd3"
                                                    ...
                                                    required minlength="8">
                                                <button class="btn btn-outline-secondary" type="button"
                                                    onclick="togglePass('pwd3')"><i class="fas fa-eye"></i></button>
                                            </div>
                                            @error('password')<div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Minimum 8 caractères</small>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold">Confirmation <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="password" name="password_confirmation" id="pwd4"
                                                    class="form-control form-control-lg" required>
                                                <button class="btn btn-outline-secondary" type="button"
                                                    onclick="togglePass('pwd4')"><i class="fas fa-eye"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label fw-bold ms-2" for="terms">
                                        J'accepte les <a href="{{ route('terms') }}" target="_blank">Conditions
                                            Générales</a>
                                        et la <a href="{{ route('privacy') }}" target="_blank">Politique de
                                            Confidentialité</a>
...
<template id="templateParticulierStep3">
    <div class="text-center py-5">
        ...
        <p class="text-muted">En tant que particulier, vous pourrez définir vos projets après activation de votre
            compte.</p>
...
<template id="templateEntrepriseStep3">
    <div class="mb-4">
        <label class="form-label fw-bold mb-3"><i class="fas fa-hand-holding-usd me-2"></i>Demande de financement
            (optionnel)</label>
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-6">
                <div class="card funding-option h-100"
                    onclick="selectFundingType({{ $type->id }}, '{{ $type->name }}', {{ $type->amount ?? 0 }})"
                    id="funding-option-{{ $type->id }}">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h6 class="mb-0 fw-bold">{{ $type->name }}</h6>
                            <span class="badge bg-primary">{{ number_format($type->amount ?? 0, 0, ',', ' ') }}
                                FCFA</span>
                        </div>
                        <p class="text-muted small mb-2">{{ Str::limit($type->description, 80) }}</p>
                        <small class="text-muted"><i class="fas fa-calendar me-1"></i> {{ $type->duration_months ?? 12
                            }} mois</small>
                    </div>
                </div>
            </div>
        ...
        <div class="card funding-option border-success"
            onclick="selectFundingType('custom', 'Demande personnalisée', 0)" id="funding-option-custom">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div>
                        <h6 class="mb-0 fw-bold text-success"><i class="fas fa-sliders-h me-2"></i>Demande personnalisée
                        </h6>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="funding_needed" id="funding_needed" class="form-control"
                                min="1000" step="1000" onchange="saveProjectData()">
                            <small class="text-muted">Minimum: 1 000 FCFA</small>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Durée (mois) <span class="text-danger">*</span></label>
                            <input type="number" name="duration" id="duration" class="form-control" min="6" max="60"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="project_name" id="project_name" class="form-control"
                                placeholder="Ex: Extension unité de production" onchange="saveProjectData()">
                        </div>
                        <div class="col-12">
                            ...
                            <textarea name="project_description" id="project_description" rows="3" class="form-control"
                                placeholder="Décrivez votre projet..." minlength="50"
                                onchange="saveProjectData()"></textarea>
