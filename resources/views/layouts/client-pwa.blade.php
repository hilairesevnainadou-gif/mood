...
<head>
    ...
    <title>Vérification d'email - BHDM</title>
    ...
    <style>
        :root {
            --client-primary: #1b5a8d;
            --client-secondary: #ff5a58;
            --client-accent: #4aafff;
            --client-dark: #0a1f44;
            --client-light: #f8f9fa;
        ...
        * {
        ...
        .header-actions {
            width: 40px; /* Largeur fixe pour aligner avec l'espace laissé */
        }
...
<body>
    <div class="pwa-verification-container">
        ...
        <div class="pwa-verification-header">
            <!-- Espace vide à gauche pour symétrie -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateSteps() {
                // Pour l'exemple, on active les étapes au hasard
                // En réalité, vous pourriez vouloir une logique différente
                let activeStep = Math.floor(Math.random() * 4); 
